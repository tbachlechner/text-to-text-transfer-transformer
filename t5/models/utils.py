...
def get_targets_and_examples(tasks, dataset_fn, eval_summary_dir, get_examples):
  ...
  Args:
    ...
    get_examples: function, retruns examples from the dataset.
  Returns:
